...
function x(a,c){if(!c&&a.j||a.c)return i;delete a.e;delete a.f;delete a.a;return a.c=g}function w(a,c){var b=c?a.f:a.e,b=Array.prototype.slice.call(b,0);Array.prototype.sort.call(b,a.o);for(var d=b.length,e=[];d--;){var h=b[d],f=h.q;if(a.a[f]){var q=a,r=q.a[f];if(n(r))for(var u=0,A=r.length;u<A;u++)h.l(r[u].val);else h.l(r.val);delete q.a[f];e.push(d)}}d=0;for(q=e.length;d<q;d++)Array.prototype.splice.call(b,e[d],1)}l.prototype.o=function(a,c){return a.n<c.n};var z=m||(m=t());k("ss.server",z);k("ss.server.run",z.h);k("ss.server.hook",z.m);k("ss.server.ready",z.g);k("ss.server.dispose",z.k);k("ss.server.Server2jsClass",t);}.call(this);
